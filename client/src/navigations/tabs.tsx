...
export default function MyTabs() {
  return (
    <Tab.Navigator>
      ...
      <Tab.Screen name="ScheduleExam" component={ScheduleExamIndex}  options={{headerShown: false, lazy: true, tabBarIcon: (props) => <IconCalendar size={20} color={props.color}/>, tabBarIconStyle: {marginBottom: -10}, tabBarLabelStyle: {marginBottom: 5}, tabBarActiveTintColor: colors.green, tabBarLabel: "Lịch khám" }} />
